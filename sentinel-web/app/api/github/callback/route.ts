...
function getWriteClient(userClient: SupabaseClient) {
...
async function syncInstallationData(supabase: SupabaseClient, teamId: string, installationId: string) {
...
export async function GET(request: Request) {
  ...
  if (!installationId || !teamId) {
    return NextResponse.redirect(new URL("/?error=missing-installation", request.url));
  }
  ...
  if (updateError) {
    ...
    return NextResponse.redirect(new URL("/?error=installation-save-failed", request.url));
  }
